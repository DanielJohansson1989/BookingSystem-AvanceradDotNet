    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Test AB" });

            migrationBuilder.InsertData(
                table: "Customer",
                columns: new[] { "CustomerId", "EmailAddress", "FirstName", "LastName", "PhoneNumber" },
                values: new object[] { 1, "daniel@johansson.se", "Daniel", "Johansson", "1234567890" });

            migrationBuilder.InsertData(
                table: "Appointment",
                columns: new[] { "AppointmentId", "AppointmentEnd", "AppointmentStart", "CompanyId", "CustomerId" },
                values: new object[] { 1, new DateTime(2024, 6, 16, 10, 30, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 16, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 });
